...
// ESP32-S3 uses DFS (Dynamic Frequency Scaling) via enableModemSleep() instead of manual frequency setting
...
>>>>>>> parent of c007293cf (Merge branch 'v4_light_sleep' into home_firmware)
